...
@section('title', 'Kontak Kami - ePosyandu Banjarsari')
@section('body')
    ...
    <section id="kontakKami" class="my-10">
        <div class="container mx-auto">
            <iframe class="w-full"
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.5783398827275!2d112.58050997410663!3d-7.174641892830224!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e77ff98097b5e1f%3A0x86d4a7fd729d352e!2sJl.%20Raya%20Banjarsari%20No.1%2C%20Banjai%20Sari%2C%20Banjarsari%2C%20Kec.%20Cerme%2C%20Kabupaten%20Gresik%2C%20Jawa%20Timur%2061171!5e0!3m2!1sid!2sid!4v1704706841461!5m2!1sid!2sid"
                ...
                <div class="flex flex-wrap justify-center break-all items-center md:gap-10 sm:justify-between">
                    ...
                    <div class="flex items-center gap-4 w-full my-5 sm:w-1/3 md:w-auto lg:w-1/3">
                        ...
                        <div>
                            ...
                            <p class="font-['Poppins'] font-reguler text-sm md:text-base">Jl. Raya Banjarsari No. 001 Desa
                                Banjarsari Kec. Cerme Kab. Gresik, 61171</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 w-full my-5 sm:w-auto">
                        ...
                        <div class="min-w-0">
                            ...
                            <div class="font-['Poppins'] font-reguler text-sm break-words md:text-base">
                                Banjarsari61171cerme@gmail.com</div>
                        </div>
                    </div>
                </div>
            </div>
