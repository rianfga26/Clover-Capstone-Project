        ...
        <div class="card">
            ...
            <div class="card-body">
                <button type="button" class="btn btn-secondary btn-lg" data-bs-toggle="modal"
                    data-bs-target="#posyanduModal">Tambah data</button>
                        ...
                        @forelse ($posyandus as $posyandu)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#deletePosyanduModal"
                                        wire:click="deletePosyandu({{ $posyandu->id }})"
