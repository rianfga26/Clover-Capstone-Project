...
<head>
    ...
    <style>
        /* Ganti warna latar belakang dan teks untuk kelas btn-secondary */
        .btn-secondary {
        ...
        /* Jika Anda ingin mengubah warna ketika tombol dihover atau diaktifkan */
        .btn-secondary:hover,
        .btn-secondary:active,
        .btn-secondary:focus {
            background-color: #017493;
            /* Warna yang berbeda ketika dihover atau diaktifkan */
            border-color: #017493;
            color: #fff;
            /* Ganti warna teks sesuai kebutuhan Anda */
        }
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->is('admin/kategori/*') ? 'active' : '' }}  has-sub ">
                            ...
                            <ul class="submenu {{ request()->is('admin/kategori/*') ? 'submenu-open' : '' }}">

                                <li class="submenu-item {{ request()->routeIs('admin.master.posyandu') ? 'active' : '' }}">
                                    <a href="{{ route('admin.master.posyandu') }}" class="submenu-link">Posyandu</a>

                                </li>

                                <li class="submenu-item {{ request()->routeIs('admin.master.dokumentasi') ? 'active' : '' }} ">
                                    <a href="{{ route('admin.master.dokumentasi') }}" class="submenu-link">Dokumentasi</a>
