        ...
        <div class="flex">
            <div class="w-full bg-white px-5 pt-2 sm:px-10 h-screen sm:w-1/2">
                ...
                <div class="flex flex-col justify-start mt-20 px-5 md:w-3/4">
                    ...
                    <div class="text-[#032D23] font-semibold text-lg font-['Source_Sans_3']">Masukkan email akun anda.
                    </div>
                    <form action="{{ route('forgot.pw.post') }}" method="post" class="mt-5">
                        ...
                        @enderror
                        <button type="submit"
                            class="w-full text-white font-['Poppins'] font-semibold py-3 mt-3 rounded bg-[#032D23]">Kirim</button>
                    </form>
                    <a href="{{ route('login') }}"
                        class="text-[#018CB5] font-semibold font-['Poppins'] mx-auto mt-3 text-sm sm:text-base sm:mt-4">Kembali</a>
                </div>
            </div>
