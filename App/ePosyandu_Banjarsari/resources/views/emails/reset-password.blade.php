...
<body style="background-color: #e9ecef;">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <![endif]-->
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 100px;">
                    <tr>
                        <td align="" valign="top" style="padding: 36px;">
                            <img src="{{ asset('/img/logo.png') }}" alt="Logo" border="0" width="38"
                                style="display: inline; width: 38px; max-width: 38px; min-width: 38px;">
                        </td>
                        <td align="left" valign="top" style="padding: 36px; padding-right: ">
                            <p style="color: #018CB5; font-family: sans-serif; font-weight: 600; font-size: 14px;">
                                ePosyandu
                                <span style="color: #000000; font-family: sans-serif;">Banjarsari</span>
                            </p>
                        </td>
                    </tr>
                </table>
